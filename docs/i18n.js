(function () {
  ...
  const locale = supported.includes(saved) ? saved : (supported.includes(browserLanguage) ? browserLanguage : 'ro');
  ...
  const messages = {
    ro: {
      ...
      backArticles: 'Înapoi la articole', backEvents: 'Înapoi la evenimente', loading: 'Se încarcă…',
      articleMissing: 'Articolul nu a fost găsit.', eventMissing: 'Evenimentul nu a fost găsit.',
    ...
    en: {
      ...
      backArticles: 'Back to articles', backEvents: 'Back to events', loading: 'Loading…',
      articleMissing: 'The article could not be found.', eventMissing: 'The event could not be found.',
    ...
    de: {
      ...
      backArticles: 'Zurück zu den Artikeln', backEvents: 'Zurück zu den Veranstaltungen', loading: 'Wird geladen…',
      articleMissing: 'Der Artikel wurde nicht gefunden.', eventMissing: 'Die Veranstaltung wurde nicht gefunden.',
