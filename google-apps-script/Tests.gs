function runA1SelfTests() {
  ...
  test('homepage contacts accept approved public contact values', function () { const value = validateHomepageContacts_({ email: 'office@example.org', whatsappUrl: 'https://chat.whatsapp.com/example_group', facebookUrl: 'https://www.facebook.com/example', linkedinUrl: 'https://www.linkedin.com/company/example', youtubeUrl: 'https://www.youtube.com/@example', zvrNumber: '1234567890' }); expect(value.email === 'office@example.org', 'Contact email changed unexpectedly.'); expect(value.youtubeUrl === 'https://www.youtube.com/@example', 'YouTube URL changed unexpectedly.'); expect(value.zvrNumber === '1234567890', 'ZVR number changed unexpectedly.'); });
  test('homepage contacts accept WhatsApp channel links', function () { const value = validateHomepageContacts_({ email: '', whatsappUrl: 'https://www.whatsapp.com/channel/example_channel', facebookUrl: '', linkedinUrl: '', youtubeUrl: '', zvrNumber: '' }); expect(value.whatsappUrl === 'https://www.whatsapp.com/channel/example_channel', 'WhatsApp channel URL changed unexpectedly.'); });
  test('homepage language settings keep Romanian enabled', function () { const value = validateLanguageSettings_({ ro: true, de: true, en: false }); expect(value.ro === true && value.de === true && value.en === false, 'Language settings changed unexpectedly.'); expectCode('VALIDATION_ERROR', function () { validateLanguageSettings_({ ro: false, de: true, en: false }); }); });
  test('homepage contacts reject invalid email, URL, and ZVR values', function () { expectCode('VALIDATION_ERROR', function () { validateHomepageContacts_({ email: 'not-an-email', whatsappUrl: '', facebookUrl: '', linkedinUrl: '', youtubeUrl: '', zvrNumber: '' }); }); expectCode('INVALID_URL', function () { validateHomepageContacts_({ email: '', whatsappUrl: 'https://example.org/group', facebookUrl: '', linkedinUrl: '', youtubeUrl: '', zvrNumber: '' }); }); expectCode('INVALID_URL', function () { validateHomepageContacts_({ email: '', whatsappUrl: '', facebookUrl: '', linkedinUrl: '', youtubeUrl: 'https://example.org/channel', zvrNumber: '' }); }); expectCode('VALIDATION_ERROR', function () { validateHomepageContacts_({ email: '', whatsappUrl: '', facebookUrl: '', linkedinUrl: '', youtubeUrl: '', zvrNumber: 'ZVR-123' }); }); });
